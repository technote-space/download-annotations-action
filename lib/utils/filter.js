...
const isMatched = (value, includePatterns, excludePatterns, options) => {
    ...
    return (!includePatterns.length || !!multimatch_1.default(value, includePatterns, options).length) && (!excludePatterns.length || !multimatch_1.default(value, excludePatterns, options).length);
};
