...
const execute = async (logger, octokit, context) => {
    ...
    const filtered = filter_1.filterByMessage(filter_1.filterByLevel(filter_1.filterByJobName(annotations, params_1.getIncludeJobNamePatterns(), params_1.getExcludeJobNamePatterns(), params_1.getIncludeJobNamePatternFlags(), params_1.getExcludeJobNamePatternFlags()), params_1.getIncludeLevels(), params_1.getExcludeLevels()), params_1.getIncludeMessagePatterns(), params_1.getExcludeMessagePatterns(), params_1.getIncludeMessagePatternFlags(), params_1.getExcludeMessagePatternFlags());
